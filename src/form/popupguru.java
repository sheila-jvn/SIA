...
public class popupguru extends javax.swing.JFrame {
    ...
    private void tblGuruMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblGuruMouseClicked
        ...
        gr.id = tblGuru.getValueAt(tabelGuru, 0).toString();
        gr.nip = tblGuru.getValueAt(tabelGuru, 1).toString();
        gr.nama = tblGuru.getValueAt(tabelGuru, 2).toString();
        gr.tgl_lahir = tblGuru.getValueAt(tabelGuru, 3).toString();
        gr.jk = tblGuru.getValueAt(tabelGuru, 4).toString();
        gr.telp = tblGuru.getValueAt(tabelGuru, 5).toString();
        gr.mapel = tblGuru.getValueAt(tabelGuru, 6).toString();
        gr.wali_kelas = tblGuru.getValueAt(tabelGuru, 7).toString();
        gr.itemTerpilihGuru();
        this.dispose();
